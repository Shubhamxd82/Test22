...
API_ID = int(environ.get('API_ID', '12928581'))
API_HASH = environ.get('API_HASH', '2b80f970d457fe170894242c1efcf3fc')
BOT_TOKEN = environ.get('BOT_TOKEN', '5799249233:AAEEnx8tIRU7WVFSPvGHXgHddNm4wfyVRcg')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1047454351').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001653250035').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TempDream69:TempDream69@cluster0.jv3m4wi.mongodb.net/?retryWrites=true&w=majority@")
DATABASE_NAME = environ.get('DATABASE_NAME', "etwryetruytj")
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'd22152f4a53297536e1535f98593a30f1dadf8fe')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001660290947'))
REQUEST_LOGS = int(environ.get('REQUEST_LOGS', '-1001660290947'))
